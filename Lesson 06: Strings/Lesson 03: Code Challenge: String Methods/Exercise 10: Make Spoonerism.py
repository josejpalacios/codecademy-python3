...
def make_spoonerism(word1, word2):
  # Get first letters
  word1_letter = word1[0]
  word2_letter = word2[0]

  # Create strings with new letters
  new_word1 = word2_letter + word1[1:]
  new_word2 = word1_letter + word2[1:]

  # Create words variable
  words = "{word1} {word2}".format(word1=new_word1, word2=new_word2)
